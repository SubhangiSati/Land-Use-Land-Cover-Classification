...
# Define the CNN model with hyperparameter tuning and SGD optimizer
...
sgd_optimizer = tf.keras.optimizers.SGD(
    ...
    decay=1e-6,           # Learning rate decay to prevent overshooting
    nesterov=True
)
...
log_dir = "logs/cnn_sgd/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
...
print("CNN_SGD Accuracy:", cnn_accuracy)
